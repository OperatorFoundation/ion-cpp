...
class NounType
{
  public:
    ...
    static constexpr int BUILTIN_NILAD = 7;
    static constexpr int BUILTIN_MONAD = 8;
    static constexpr int BUILTIN_DYAD = 9;
    static constexpr int BUILTIN_TRIAD = 10;
    static constexpr int MONADIC_ADVERB = 11;
    static constexpr int DYADIC_ADVERB = 12;
    static constexpr int TRIADIC_ADVERB = 13;
    static constexpr int USER_SYMBOL = 14;
    static constexpr int USER_NILAD = 15;
    static constexpr int USER_MONAD = 16;
    static constexpr int USER_DYAD = 17;
    static constexpr int USER_TRIAD = 18;
    static constexpr int ERROR = 19;
    static constexpr int EXPRESSION = 20;
    static constexpr int TYPE = 21;
    static constexpr int CONDITIONAL = 22;
    static constexpr int QUOTED_SYMBOL = 23;
    static constexpr int EFFECT_TYPE = 24;
    static constexpr int RESOURCE = 25;
    static constexpr int CONTINGENCY = 26;
    static constexpr int SIGNAL = 27;
    static constexpr int SEQUENCE = 28;
    static constexpr int DEPENDENCY = 29;
    static constexpr int EFFECT_EXPRESSION = 30;
    static constexpr int LENS = 31;
    static constexpr int EFFECT_CHAIN = 32;
    static constexpr int NILADIC_EFFECT = 33;
    static constexpr int MONADIC_EFFECT = 34;
    static constexpr int DYADIC_EFFECT = 35;
    static constexpr int TRIADIC_EFFECT = 36;
    static constexpr int CONJUNCTION = 37;
